...
class cylinder : public world_object {
    public:
        cylinder(){}
        cylinder(double x0,double z0,double h,double r, bool hollow, material mat){
            this->x0=x0;
            this->z0=z0;
            this->h=h;
            this->r=r;
    ...
    private:
        ...
        // equation of cylinder used : (x-x0)^2 + (z-z0)^2 = r^2  for 0<y<h
        // equation of cylinder on simplifying :  x^2 + 2(-x0)x + z^2 + 2(-z0)z + (x0^2 + z0^2 - r^2)
};